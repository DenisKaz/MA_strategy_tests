...
class FetchConfig:
    ...
    # Потоковая запись: если True, данные будут записываться по частям (batch) в CSV
    # по мере получения. Рекомендуется для больших объёмов (1m, 3m, 5m за годы).
    stream_write: bool = True
